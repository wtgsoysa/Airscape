...
<div class="container d-flex flex-column align-items-center justify-content-center" style="min-height: 100vh;">
    ...
    <div class="text-center mb-4">
        <div class="airscape-logo"><img src="<?php echo e(asset('assets/Logo.svg')); ?>" alt=""></div>
    </div>
    ...
    <div class="row justify-content-center w-100 gap-4 px-3">
        ...
        <div class="col-10 col-sm-6 col-md-4 col-lg-3">
            <a href="<?php echo e(route('login.webmaster')); ?>" class="text-decoration-none">
        ...
        <!-- Administrator -->
        <div class="col-10 col-sm-6 col-md-4 col-lg-3">
            <a href="<?php echo e(route('login.admin')); ?>" class="text-decoration-none">
                <div class="role-card text-center">
                    <div class="role-icon">
                        <i class="bi bi-person-circle"></i>
                    </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dinuli Nethmini\Desktop\Uni Works\Y2 S2\SQA\Airscape\Airscape\resources\views/auth/role-selection.blade.php ENDPATH**/ ?>