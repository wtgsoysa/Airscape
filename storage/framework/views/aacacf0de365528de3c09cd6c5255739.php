...
<div class="no-access-card">
    ...
    <div class="button-group">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="btn-soft">Return to Dashboard</a>
    </div>
</div>

<div class="footer-note">
    © <?php echo e(date('Y')); ?> AirScape • Designed for calm intelligence
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dinuli Nethmini\Desktop\Uni Works\Y2 S2\SQA\Airscape\Airscape\resources\views/errors/no-access.blade.php ENDPATH**/ ?>