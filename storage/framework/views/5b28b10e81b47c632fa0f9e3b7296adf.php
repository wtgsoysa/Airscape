            ...
            <tbody>
                ...
                <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge <?php echo e($rec['status'] == 'Active' ? 'bg-success' : 'bg-danger'); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\University\SDTP\Airscape\resources\views/pages/admin/data-management.blade.php ENDPATH**/ ?>